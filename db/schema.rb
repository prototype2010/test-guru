...
ActiveRecord::Schema.define(version: 20_230_705_092_735) do
  ...
  create_table 'rules', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['circumstance'], name: 'index_rules_on_circumstance', unique: true
  end
  ...
  create_table 'test_passages', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.datetime 'end_time', default: '2023-07-05 10:07:23', null: false
    t.boolean 'badge_given', default: false
  ...
  create_table 'tests', force: :cascade do |t|
    ...
    t.integer 'time_limit', default: 3, null: false
